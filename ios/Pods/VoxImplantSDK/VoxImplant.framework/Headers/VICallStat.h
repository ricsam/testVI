...
/**
 * Stream direction: [VIStreamDirection.VIStreamDirectionSend] for streams directed from this device,
 * [VIStreamDirection.VIStreamDirectionRecv] for streams directed to this device.
 */
@property(nonatomic, assign, readonly) VIStreamDirection dir;

/**
 * Stream type: [VIStreamType.VIStreamTypeAudio] or [VIStreamType.VIStreamTypeVideo]. [VIStreamType.VIStreamTypeUnknown] for
